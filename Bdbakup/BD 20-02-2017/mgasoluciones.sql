...
(6, 'user@user.com', 'user', 'user', 'user', 'user', 'user', '2017-02-01', 1, '98765432', '1;3;3;calle 3', b'1');
...
--
ALTER TABLE `tbfrecuencyview`
  MODIFY `idfrecuencyview` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
--
