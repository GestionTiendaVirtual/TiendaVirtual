...
--
-- Servidor: localhost
-- Tiempo de generación: 26-02-2017 a las 22:10:00
...
--
-- Volcado de datos para la tabla `tbcanceledsales`
--
...
--
-- Estructura de tabla para la tabla `tbevaluationwallclient`
--

CREATE TABLE `tbevaluationwallclient` (
  `idevaluation` int(11) NOT NULL,
  `idproduct` int(11) NOT NULL,
  `idclient` int(11) NOT NULL,
  `criterion` varchar(100) NOT NULL,
  `metrics` varchar(100) NOT NULL,
  `indexproduct` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbevaluationwallgeneral`
--

CREATE TABLE `tbevaluationwallgeneral` (
  `idevaluation` int(11) NOT NULL,
  `idproduct` int(11) NOT NULL,
  `criterion` varchar(100) NOT NULL,
  `metrics` varchar(100) NOT NULL,
...
(63, '2017-02-23', 5, 0, 1, 0),
(64, '2017-02-23', 5, 0, 1, 0),
(65, '2017-02-26', 5, 0, 1, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbfrecuencyview`
--
...
--
-- Volcado de datos para la tabla `tbfrecuencyview`
--
...
(1, 'Huawei', 'P8 lite', 180000, 'Muy buen celular', 1, 1, 'Celular huawei', 'grandee', '45245jhjh', b'1'),
...
(5, 'Huawei', 'P9', 345000, 'Descripcion', 1, 1, 'Celular Huawei', 'hjhjhhj', 'hjjhhj', b'1'),
...
--
-- Volcado de datos para la tabla `tbproductcalification`
--
...
(1, 5, 1, b'1', '2017-02-23'),
(2, 6, 1, b'1', '2017-02-23'),
(3, 5, 5, b'1', '2017-02-23');
...
--
-- Volcado de datos para la tabla `tbproductliked`
--
...
--
-- Estructura de tabla para la tabla `tbproductmodifications`
--
...
--
-- Volcado de datos para la tabla `tbproductmodifications`
--

INSERT INTO `tbproductmodifications` (`idmodification`, `idproduct`, `nameproduct`, `priceproduct`, `descriptionproduct`, `characteristicsproduct`, `colorproduct`, `specificationproduct`, `imagesproduct`, `active`) VALUES
(1, 1, 'Celular Huawei', 180000, 'Muy buen celular', 'grandee', b'1', b'1', b'0', b'0'),
(2, 1, 'Celular', 0, '0', '0', b'0', b'0', b'1', b'0'),
(3, 5, 'Celular Huawei', 0, '0', '0', b'0', b'0', b'0', b'0');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbproductpoints`
--
...
--
-- Volcado de datos para la tabla `tbproductpoints`
--
...
--
-- Indices de la tabla `tbfrecuencyview`
--
...
--
-- Indices de la tabla `tbproductcalification`
--
...
--
-- Indices de la tabla `tbproductmodifications`
--
ALTER TABLE `tbproductmodifications`
  ADD PRIMARY KEY (`idmodification`);

--
-- Indices de la tabla `tbproductpoints`
--
...
--
-- AUTO_INCREMENT de la tabla `tbfrecuencyview`
--
ALTER TABLE `tbfrecuencyview`
  MODIFY `idfrecuencyview` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
--
...
--
-- AUTO_INCREMENT de la tabla `tbproductcalification`
--
ALTER TABLE `tbproductcalification`
...
--
-- Filtros para la tabla `tbfrecuencyview`
--
ALTER TABLE `tbfrecuencyview`
